...
export default function Header() {
  ...
  return (
    <header className="w-full h-16 bg-header-gradient px-6 lg:px-16 py-2 flex justify-between fixed top-0 z-50 backdrop-blur-sm">
      <div className="flex flex-row items-center justify-between w-full">
        ...
        <nav className={isMobileMenuOpen ? "menu menu--open" : "menu"}>
          ...
          <div className="z-10 lg:flex relative items-end mt-8 lg:mt-0 lg:ml-auto">
            <button
            ...
            {isSubMenuOpenUser && (
              <div className="absolute top-full left-0 lg:right-0 lg:left-auto w-48 bg-dark mt-3 lg:mt-0 shadow-2xl z-[60]">
                <div className="flex flex-col gap-3 py-4">
                  <div className="px-4">
