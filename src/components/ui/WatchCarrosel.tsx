  ...
  return (
    <section className="w-full pb-12 pl-6 lg:px-0 lg:pl-16 bg-dark overflow-hidden">
      ...
      <div
        ...
        className={`flex flex-nowrap gap-6 pl-1 select-none transition-cursor duration-100 overflow-x-auto lg:overflow-hidden scrollbar-hide overscroll-x-contain ${
